 ...
 * @author amin
 */
public final class CompareColumnResult {

    private Map<String, String> groundTruthTable = new LinkedHashMap<>();
    private Map<String, String> userTable = new LinkedHashMap<>();
     ...
     */
    public Map<String, String> getGroundTruthTable() {
     ...
     */
    public void setGroundTruthTable(Map<String, String> groundTruthTable) {
     ...
     */
    public void setUserTable(Map<String, String> userTable) {
